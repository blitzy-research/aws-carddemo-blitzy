 ...
 *        read out of it.
 *
 * <p><strong>Eight of the components are regulated, and this record is not what protects them.</strong>
 * The three national-identifier positions, the three date-of-birth positions, the government-issued
 * identifier and the electronic-funds account identifier are gated by
 ...
 * rather than from the adapter's result therefore defeats the protection completely, which is why a
 * production-source audit forbids any other reader of those stored values.
 *
 * @since 1.0.0
 */
