...
class UserRequestTest {
    ...
    class ValueFidelity {
        ...
        void acceptsASelectionSequenceAtTheRowCount() {
            ...
            for (int row = 0; row < UserRequest.ROW_SELECTION_COUNT; row++) {
                full.add("S");
            }
            ...
            assertThat(request.rowSelections()).hasSize(UserRequest.ROW_SELECTION_COUNT);
            assertThat(violationsOf(request)).isEmpty();
        }
        ...
        void refusesASelectionSequenceLongerThanTheRowCount() {
            ...
            assertThatExceptionOfType(IllegalArgumentException.class)
                    ...
                    .withMessageContaining(String.valueOf(UserRequest.ROW_SELECTION_COUNT))
